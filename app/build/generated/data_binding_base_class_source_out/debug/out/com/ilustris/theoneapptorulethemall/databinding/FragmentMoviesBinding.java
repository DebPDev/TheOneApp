...
public final class FragmentMoviesBinding implements ViewBinding {
  ...
  @NonNull
  public final ViewPager2 movieList;

  private FragmentMoviesBinding(@NonNull LinearLayout rootView, @NonNull ViewPager2 movieList) {
  ...
  public static FragmentMoviesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.movieList;
      ViewPager2 movieList = ViewBindings.findChildViewById(rootView, id);
      if (movieList == null) {
        break missingId;
      }

      return new FragmentMoviesBinding((LinearLayout) rootView, movieList);
    }
